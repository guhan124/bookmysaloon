    ...
    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-5">
        <div class="text-center col">
            ...
            <label class="btn btn-border d-block p-1" for="dashboard">
                <img class="img-fluid" src="{{ asset('/images/dashboard/Dashboard.jpg') }}">
        ...
        <div class="text-center col">
            ...
            <label class="btn btn-border d-block p-1" for="dashboard_1">
                <img class="img-fluid" src="{{ asset('/images/dashboard/Dashboard -1.jpg') }}">
        ...
        <div class="text-center col">
            ...
            <label class="btn btn-border d-block p-1" for="dashboard_2">
                <img class="img-fluid" src="{{ asset('/images/dashboard/Dashboard -2.jpg') }}">
        ...
        <div class="text-center col">
            ...
            <label class="btn btn-border d-block p-1" for="dashboard_3">
                <img class="img-fluid" src="{{ asset('/images/dashboard/Dashboard -3.jpg') }}">
        ...
        <div class="text-center col">
            ...
            <label class="btn btn-border d-block p-1" for="dashboard_4">
                <img class="img-fluid" src="{{ asset('/images/dashboard/Dashboard -4.jpg') }}">
